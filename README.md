...
- Navigate to `yacabot` folder
- Select `yacabot.bot` file
...
msbot clone services --name "yacabot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
